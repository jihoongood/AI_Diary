...
import numpy as np
from allmodule_test_web import *
...
#    st.write("일기를 작성하시면 AI가 일기 속의 숨겨진 노래를 찾아내 감정을 채워드립니다.")
    ...
    input_data = st.text_area("여기에 일기를 입력하세요!")

    # 여기서 input_data를 감정분석 프로그램에 넘겨주고 그 인수를 받아와야 한다.

    Push_listen_button = st.button("Listen")
    if Push_listen_button:
        # print(diary(input_data))
        # st.info(result)
